...
const PaperGenerator = () => {
  ...
  return (
    <div className="paper-generator">
      <ParallaxSection className="generator-header">
        <h2 className="text-2xl font-bold mb-2">Question Paper Generator</h2>
        <p>Create comprehensive examination papers with AI assistance</p>
      </ParallaxSection>
      
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <Card title="Configure Paper">
          <div className="mb-4">
